...
const PatientAppointmentDetailsModal = ({handleClose, handleOpenSecondModal, handleOpenThirdModal}) => {
  return (
    <Modal
    ...
    >
      <div className="flex flex-col gap-y-[24px]">
        ...
        <div className="h-[70px] mb-[16px] rounded-[6px] flex p-[15px] border-l-[4px] border-[#6b5dd3] bg-[#f0effb] justify-between items-center">
