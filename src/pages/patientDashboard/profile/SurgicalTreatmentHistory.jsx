...
const SurgicalTreatmentHistory = ({handleSelect}) => {
   return (
    <div>
      ...
      <div className="flex flex-col gap-y-[32px]">
        <div className="flex justify-between items-center">
          <p className="font-bold text-2xl">Surgical History</p>
        ...
        <div className="grid grid-cols-3 gap-[24px]">
          <div className="py-[22px] px-[16px] border border-[#eaecf0] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] rounded-[7px]">
            <p className="mb-[20px] font-medium">Appendectomy</p>
            <div className="rounded-[7px] p-[11px]">
...
export default SurgicalTreatmentHistory